...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_menu_items_allergen_tags" AS ENUM('Gluten', 'Milch', 'Sahne', 'Ei', 'Senf', 'Sesam', 'Fisch', 'Sellerie');
  ...
  CREATE TABLE "menu_items_allergen_tags" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_menu_items_allergen_tags",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "menu_items" (
  	...
  	"price_tbd" boolean DEFAULT false,
  	"badge" varchar,
  	"photo_id" integer,
  	"image_alt" varchar,
  	"show_image" boolean,
  	"compact_card" boolean DEFAULT false,
  ...
  ALTER TABLE "menu_items_allergen_tags" ADD CONSTRAINT "menu_items_allergen_tags_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "menu_items" ADD CONSTRAINT "menu_items_photo_id_media_id_fk" FOREIGN KEY ("photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "menu_items_allergen_tags_order_idx" ON "menu_items_allergen_tags" USING btree ("order");
  CREATE INDEX "menu_items_allergen_tags_parent_idx" ON "menu_items_allergen_tags" USING btree ("parent_id");
  CREATE UNIQUE INDEX "menu_items_item_number_idx" ON "menu_items" USING btree ("item_number");
  CREATE INDEX "menu_items_category_idx" ON "menu_items" USING btree ("category_id");
  CREATE INDEX "menu_items_photo_idx" ON "menu_items" USING btree ("photo_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "menu_items_allergen_tags" CASCADE;
  ...
  DROP TYPE "public"."enum_menu_items_allergen_tags";`)
}
