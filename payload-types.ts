...
export interface MenuCategory {
  ...
  name: string;
  /**
   * URL-Kennung, z. B. klassiker, grillgerichte
   */
  slug: string;
  /**
   * Emoji für Tabs, z. B. 🥩
...
export interface MenuItem {
  id: number;
  /**
   * Nummer auf der gedruckten Karte, z. B. 51 oder 314
   */
  itemNumber: string;
  ...
  badge?: string | null;
  /**
   * Zusätzlich zu automatischen Regeln auf der Website
   */
  allergenTags?: ('Gluten' | 'Milch' | 'Sahne' | 'Ei' | 'Senf' | 'Sesam' | 'Fisch' | 'Sellerie')[] | null;
  photo?: (number | null) | Media;
  imageAlt?: string | null;
  /**
   * Deaktivieren für kompakte/text-only Karten
   */
  showImage?: boolean | null;
