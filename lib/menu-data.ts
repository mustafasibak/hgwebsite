...
export const menuCategories: MenuCategory[] = [
  {
    ...
    icon: '⭐',
    items: [
      { id: '2', name: '1/2 Grill Hähnchen ohne Sauce', price: 5.5 },
      { id: '1', name: '1/2 Grillhähnchen mit (Sauce)', price: 6.5 },
      { id: '111', name: 'Ganz Grillhähnchen ohne Sauce', price: 11.0 },
      { id: '102', name: 'Halbs Grillhähnchen ohne Sauce', desc: 'mit Pommes', price: 8.5 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '215', name: 'Rumpsteak', desc: 'Folienkartoffel, Sour Cream, Knobibrot,Salatbeilage', price: 15.5 },
    ]
  },
  {
    name: 'Grillplatten',
    icon: '🍽️',
    items: [
      { id: '222', name: 'Grillplatte für 2 Personen', price: 30.0 },
      { id: '333', name: 'Grillplatte für 3 Personen', price: 42.0 },
      { id: '666', name: 'XXL Grillplatte für 2 Personen + 2 x 0,3l Getränk', desc: 'Lamm, Rind, Pute, Adana Spieß, Hähnchen', price: 40.0 },
    ]
  },
  {
    name: 'Snacks',
    ...
    items: [
      ...
      { id: '55', name: 'Hamburger(Rind)', price: 3.5, tags: ['Milch', 'Sesam'] },
      { id: '56', name: 'Big Hamburger', price: 5.0, tags: ['Sesam'] },
      { id: '57', name: 'Cheeseburger', price: 4.0, tags: ['Sesam'] },
      { id: '58', name: 'Big Cheeseburger', price: 5.5, tags: ['Sesam'] },
      { id: '60', name: 'Crispy Chicken- Filet (4 Stk)', desc: 'mit Sauce', price: 5.0 },
      { id: '260', name: 'Chickenwings ( 4 Stk)', desc: 'mit Sauce', price: 5.0 },
      ...
      { id: '225', name: 'Falafel Sandwich XXL', price: 5.5, tags: ['Gluten', 'Milch'] },
  ...
  },
  {
    ...
    icon: '🥖',
    items: [
      { id: '71', name: 'Groque Schawarma', desc: 'Gurke, Ei, Jalapinio', price: 9.5 },
      { id: '172', name: 'Croque Chili', desc: 'Adana, Tomate, Jalapenos', price: 9.5 },
      { id: '59', name: 'Croque Camembert Preiselbeeren', price: 7.0 },
      { id: '160', name: 'Croque Pute', desc: 'Putenfleisch geformt, Ananas', price: 8.0 },
      { id: '61', name: 'Croque Hähnchen', desc: 'Hähnchenfleisch + Tomaten', price: 8.0 },
      { id: '62', name: 'Croque Frikadelle', desc: '+ Tomaten', price: 8.0 },
      { id: '63', name: 'Croque Hawaii', desc: 'Truthahn-Schinken, Ananas', price: 8.0 },
      { id: '64', name: 'Croque Madame', desc: 'Gurke, Tomate', price: 7.0 },
      { id: '165', name: 'Croque Schafkäse', desc: 'Weißkäse, Tomate, Gurke', price: 8.0 },
      { id: '65', name: 'Croque Salami', desc: 'Rindfleisch-Salami, Gurke', price: 8.0 },
      { id: '66', name: 'Croque Monsieur', desc: 'Truthahn-Schinken, Tomate', price: 8.0 },
      { id: '67', name: 'Croque Toulouse Thunfisch', desc: 'Tomaten, Zwiebeln', price: 8.0 },
      { id: '68', name: 'Croque Gyros', desc: 'Tomaten,Hähnchenbrust', price: 8.0 },
      { id: '69', name: 'Croque Spezial Camembertkäse', desc: 'Hähnchenschnitzel,Tomaten', price: 8.5 },
      { id: '164', name: 'Croque Lohbrügger', desc: 'Spinat, Weißkäse, Tomate', price: 7.0 },
      { id: '159', name: 'Croque Mozzarella', desc: 'Tomate, Käse', price: 7.0 },
      { id: '340', name: 'Croque Mittelmeer', desc: 'Sucuk, Weißkäse, Peperoni, Gurke', price: 8.0 },
      { id: '41', name: 'Croque Knacker', desc: 'Currywurst, Gewürzgurken, Tomaten, Zwiebeln', price: 8.0 },
      { id: '50', name: 'Croque Germany', desc: 'Garnelen, Tomate, Zwiebeln, Peperoni', price: 9.5 },
      { id: '100', name: 'Mini Croque', price: 5.5 },
      { id: '300', name: 'Extra Beilage', price: 1.5 },
      { id: '440', name: 'Croque Pastirma', desc: 'Rinderschinken, Rührei, Tomate, Weißkäse, Peperoni', price: 9.5 },
    ]
  },
  {
    name: 'Pasta',
    ...
    items: [
      ...
      { id: '249', name: 'Makkaroni Pfanne', desc: 'Gemüse, Hähnchenbrust, Gorgonzola-,Sahnesauce', price: 9.5 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '549', name: 'Garnelen Teller', desc: 'Folienkartoffel, Zwiebeln, Paprika, Rahmchampignons', price: 14.0 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '42', name: 'Kleiner Marktsalat', desc: 'Thunfisch, Ei, Eisbergsalat, Tomate, Gurke, Mais, Zwiebeln,Dressing', price: 5.9, tags: ['Ei'] },
      { id: '43', name: 'Großer Marktsalat', desc: 'Thunfisch, Ei, Eisbergsalat, Tomate, Gurke, Mais, Zwiebeln,Dressing', price: 8.0, tags: ['Ei'] },
      ...
      { id: '342', name: 'Kleiner Fitness-Teller-Salat', desc: 'Hähnchenstreifen, Eisbergsalat, Ananas, Tomate, Gurke,Dressing', price: 6.9 },
      { id: '144', name: 'Großer Fitness-Teller-Salat', desc: 'Hähnchenstreifen, Eisbergsalat, Ananas, Tomate, Gurke, Dressing', price: 9.0 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: '252', name: 'Mix Grill-Teller', desc: '2 Stk. Rindersteak, 2 Stk.Putensteak, Knobibrot, Bratkartoffeln, Sauce', price: 15.5 },
      { id: '254', name: 'Mix Hähnchen - Teller', desc: '3 Stk. Crispy Chicken, 2 Stk Wings, 1. Crispy Schnitzel, Pommes, Sauce', price: 11.0 },
      { id: '29', name: '3 Spiegeleier', desc: 'Bratkartoffeln,Salatbeilage', price: 8.0 },
      { id: '52', name: 'HHanse Grillteller Rind', desc: 'Zwei Steaks(Rind)Champignonrahmsauce, Bratkartoffeln', price: 9.9 },
      { id: '253', name: 'HHanse Grillteller Pute', desc: 'Zwei Putenmedaillons,Rahmchampignonsauce, Bratkartoffeln', price: 9.9, tags: ['Sahne'] },
      { id: '129', name: 'Bauernfrühstück', desc: 'Truthahnschinken,Gewürzgurke', price: 8.0 },
      { id: '146', name: 'Gemüse-Teller', desc: 'Folienkartoffel,Sour Cream, Rahmchampignon, weißer käse überbacken', price: 8.5 },
      { id: '112', name: 'Fit Pfanne(Pute)', desc: 'Überbackene Kartoffeln, Sour Cream,Rahmchampignons, gegrillte Putenstreifen', price: 9.5 },
      { id: '212', name: 'Chickenwings(4 Stk)', desc: 'Pommes, Sauce', price: 8.0 },
      { id: '360', name: 'Crispy Chicken Filet( 4 Stk)', desc: 'mit Pommes,Sauce', price: 8.0 },
      { id: '11', name: 'Reis-Pfanne', desc: 'Gemüse, Hähnchenbrust,Reis', price: 9.5 },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: '245', name: 'Zigeunersauce oder Jägersauce', price: 1.8 },
      { id: '460', name: 'Crispy Chicken Filet', desc: 'Menü + Pommes', price: 10.9 },
      ...
      { id: '33', name: 'Ketchup oder Mayonnaise Portion', price: 0.5 },
      { id: '133', name: 'Extra Ketchup oder Mayonnaise', price: 1.0 },
  ...
  },
  {
    ...
    icon: '🥤',
    items: [
      { id: '76', name: 'Kaffee', price: 2.0 },
      { id: '77', name: 'Heiße Schokolade', desc: 'mit milch', price: 3.0 },
      { id: '179', name: 'Cappuccino', price: 2.7 },
      { id: '180', name: 'Milchkaffee', price: 2.7 },
      { id: '181', name: 'Latte Macchiato', price: 3.0 },
      { id: '182', name: 'Espresso', price: 2.0 },
      { id: '75', name: 'Stilles Wasser', price: 1.8 },
      { id: '275', name: 'Wasser mit Kohlensäure', price: 1.8 },
      { id: '70', name: '0,33L Softgetränke', desc: '(ohne Pfand)', price: 2.8 },
      { id: '73', name: '0,5L Softgetränke', desc: '(ohne Pfand)', price: 3.0 },
      { id: '276', name: 'Ayran', price: 1.2 },
      { id: '176', name: 'Kleiner Tee', price: 0.8 },
      { id: '376', name: 'Großer Tee', price: 1.3 },
    ]
  },
]
